...
public class CaptainAmerica implements Avenger{
	...
	public String avengerName="Captain America";
	public String personName="Steve Rogers";
	public String avengerAbilities="Super-Soldier";
	...
	public void getMissionAssignAlert() {
		System.out.println("Sms is sent to Captain America");
	}
